...
echo "  training set"
python -m code.feature_extraction.extract_features data/preprocessing/split/training.csv data/feature_extraction/training.pickle -e data/feature_extraction/pipeline.pickle --char_length --ner --hashtag_count --mentions_count --reply_to_count -puvrwbdt --season --sentiment --threads

...
python -m nltk.downloader all -q -d "$(pwd)"
...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --prune_lang --pipeline tweet remove_urls lowercase expand punctuation standardize tokenize numbers lemmatize remove_stopwords -e data/preprocessing/pipeline.pickle --fast
